...
const fieldClass = cn(
  'peer w-full rounded-xl border bg-white/70 py-2.5 pl-11 pr-11 text-sm text-slate-800',
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        ...
        <div className="relative">
          <Mail className="pointer-events-none absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400 peer-focus:text-[#5B4FF7]" />
          <input
            {...register('email')}
            type="email"
      ...
      <div className="flex justify-end">
        <button type="button" className="text-sm font-medium text-[#5B4FF7] transition-colors hover:text-[#4a3fe0]">
          Forgot password?
        </button>
      </div>
